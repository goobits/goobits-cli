...
export class ConfigManager {
    ...
    protected configDirName: string;
    protected configFileName: string;
    protected _config: ConfigOptions | null;
    protected _configPath: string | null;

    /**
     * Configuration manager for Test TypeScript CLI
     */
    constructor() {
        this.packageName = 'test-typescript-cli';
        this.configDirName = 'test-typescript-cli';
     ...
     */
    mergeWithEnv(): void {
        const prefix = 'TEST_TYPESCRIPT_CLI_';
