...
readonly PACKAGE_NAME="test_python_hooks"
readonly COMMAND_NAME="test-python"
readonly DISPLAY_NAME="Python Hooks Test CLI"
readonly DESCRIPTION="Test Python hook generation"
readonly PYPI_NAME="test-python-hooks"
...
readonly SHELL_ALIAS="test-python"
