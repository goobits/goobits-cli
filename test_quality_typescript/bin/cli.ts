 ...
 * CLI executable entry point for Complex CLI Test Tool
...
async function runCLI(): Promise<void> {
  try {
    ...
    // Execute the CLI
    console.debug && console.debug(chalk.gray(`Starting Complex CLI Test Tool...`));
    await cliModule.cli();
    console.debug && console.debug(chalk.gray(`Complex CLI Test Tool completed successfully`));
    ...
    console.error(chalk.red.bold('✗ Failed to start Complex CLI Test Tool'));
    ...
    console.error(chalk.cyan('  • Ensure Complex CLI Test Tool is properly installed'));
    ...
    console.error(chalk.cyan('  • Try reinstalling: npm install -g complex-cli-test'));
