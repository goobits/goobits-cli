...
Generated from: test-multi-language.yaml
"""
...
class ConfigManager:
    ...
    def __init__(self, config_file: Optional[Path] = None):
        ...
        if config_file is None:
            config_dir = Path.home() / '.config' / 'testmulti'
...
@click.option('--enthusiastic', '-e', is_flag=True, default=False,              help='Be enthusiastic')
@click.pass_obj
def greet(ctx, name, enthusiastic):
    """Greet someone"""
    try:
        if hooks and hasattr(hooks, 'on_greet'):
            kwargs = {                'name': name,                'enthusiastic': enthusiastic,            }
