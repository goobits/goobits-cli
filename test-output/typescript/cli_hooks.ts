...
/**
 * Greet someone * @param name Name to greet * @param options Command options * @param options.enthusiastic Be enthusiastic * @returns Promise<number> - Exit code (0 for success)
 */
export async function on_greet(    name: string,    options: {        enthusiastic?: string;    }): Promise<number> {    // Implement greeting business logic with TypeScript types
...
/**
 * Show information * @param options Command options * @param options.verbose Verbose output * @returns Promise<number> - Exit code (0 for success)
 */
export async function on_info(    options: {        verbose?: string;    }): Promise<number> {    // Implement system info display logic with TypeScript types
