...
readonly PACKAGE_NAME="test-interactive-cli"
readonly COMMAND_NAME="test-cli"
readonly DISPLAY_NAME="Test Interactive CLI"
readonly DESCRIPTION="A test CLI for interactive mode integration"
readonly PYPI_NAME="test-interactive-cli"
