...
class ConfigError(Exception):
    ...
    def __init__(self, message: str, suggestion: Optional[str] = None, config_path: Optional[Path] = None):
...
class ConfigFileError(ConfigError):
    ...
    def __init__(self, message: str, config_path: Path, suggestion: Optional[str] = None):
        super().__init__(message, suggestion, config_path)


class ConfigValidationError(ConfigError):
    """Configuration validation error."""
    def __init__(self, message: str, key: str, value: Any = None, suggestion: Optional[str] = None):
        self.key = key
        self.value = value
...
class ConfigManager:
    """Configuration manager for Test Interactive CLI"""
    
    def __init__(self):
        self.package_name = 'test-interactive-cli'
        self.config_dir_name = 'test-interactive-cli'
...
class RCConfigLoader(ConfigManager):
    ...
    def find_rc_file(self, start_dir: Optional[Union[str, Path]] = None) -> Optional[Path]:
