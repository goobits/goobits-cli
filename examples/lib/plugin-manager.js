/**
 * Enhanced Plugin Manager for Nested Command Demo
...
export class PluginManager {
  ...
  _getPluginDirectories() {
    ...
    return [
      ...
      join(userConfigDir, 'goobits', 'demo', 'plugins'),
  ...
  async _discoverNpmPlugins(discovered) {
    try {
      const pluginPattern = `demo-plugin-*`;
  ...
  _isValidPlugin(pkg) {
    return (
      pkg.keywords && 
      (pkg.keywords.includes('demo-plugin') || 
