...
class ConfigManager:
    ...
    def __init__(self, config_file: Optional[Path] = None):
        ...
        if config_file is None:
            config_dir = Path.home() / '.config' / 'minimal_py'
...
@cli.command('hello')
@click.option('--name', '-None', default='World',              help='Your name')
@click.pass_obj
def hello(ctx, name):
    """Say hello"""
    try:
