...
readonly PACKAGE_NAME="minimal-python-cli"
readonly COMMAND_NAME="minimal_py"
readonly DISPLAY_NAME="Minimal Python CLI"
readonly DESCRIPTION="A minimal Python CLI"
readonly PYPI_NAME="minimal-python-cli"
...
readonly SHELL_ALIAS="minimal_py"
