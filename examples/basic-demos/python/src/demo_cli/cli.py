...
Generated from: multi-language-demo.yaml
"""
...
class ConfigManager:
    ...
    def __init__(self, config_file: Optional[Path] = None):
        ...
        if config_file is None:
            config_dir = Path.home() / '.config' / 'demo_multi'
...
@click.option('--style', '-s', default='casual',              help='Greeting style')
@click.option('--count', '-c', default=1,              help='Repeat greeting N times')
@click.option('--uppercase', '-u', default=False,              help='Convert to uppercase')
...
@click.option('--verbose', '-v', default=False,              help='Show detailed information')
@click.option('--sections', '-s', default='all',              help='Comma-separated sections to show')
@click.pass_obj
