#!/bin/bash
# Bash completion script for Demo Rust CLI (demo_rust)
# Auto-generated by goobits-cli

_demo_rust_completions() {
    local cur prev words cword
    _init_completion || return

    # Get the current CLI binary path
    local cli_bin="demo_rust"
...
complete -F _demo_rust_completions demo_rust

# Also register for common variations

# Support for cargo installation paths
if [[ -n "${CARGO_HOME:-}" ]]; then
    complete -F _demo_rust_completions "${CARGO_HOME}/bin/demo_rust"
fi

# Support for default cargo binary location
if [[ -d "$HOME/.cargo/bin" ]]; then
    complete -F _demo_rust_completions "$HOME/.cargo/bin/demo_rust"
fi