#!/bin/bash
# Bash completion script for Demo TypeScript CLI (demo_ts)
...
if [[ -n "${NPM_CONFIG_PREFIX:-}" ]]; then
    complete -F _demo_ts_completions "${NPM_CONFIG_PREFIX}/bin/demo_ts"
fi

# Support for npx execution
complete -F _demo_ts_completions "npx demo_ts"