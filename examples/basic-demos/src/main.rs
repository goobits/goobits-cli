// Demo Rust CLI - A sample Rust CLI built with Goobits
...
mod completion {
    ...
    pub fn generate_completion(app: &Command, shell: clap_complete::Shell) -> String {
        ...
        clap_complete::generate(shell, &mut app.clone(), "demo_rust", &mut buffer);
...
fn build_cli() -> Command {
    Command::new("demo_rust")
        ...
        .arg(
            ...
            Command::new("greet")
                .about("Greet someone with style")                .arg(
                    Arg::new("name")
                        .help("Name to greet")
                        .required(true)
                        .index(1)
                    ...
                    Arg::new("style")                        .short('s')                        .long("style")
                        .help("Greeting style")                        .value_name("VALUE")                )                .arg(
                    Arg::new("count")                        .short('c')                        .long("count")
                        .help("Repeat greeting N times")                        .value_name("VALUE")                )                .arg(
                    Arg::new("uppercase")                        .short('u')                        .long("uppercase")
                        .help("Convert to uppercase")                        .value_name("VALUE")                )                .arg(
                    Arg::new("language")                        .short('l')                        .long("language")
                        .help("Language code")                        .value_name("VALUE")                )        )        .subcommand(
            Command::new("info")
                .about("Display system and environment information")                .arg(
                    Arg::new("format")                        .short('f')                        .long("format")
                        .help("Output format")                        .value_name("VALUE")                )                .arg(
                    Arg::new("verbose")                        .short('v')                        .long("verbose")
                        .help("Show detailed information")                        .value_name("VALUE")                )                .arg(
                    Arg::new("sections")                        .short('s')                        .long("sections")
                        .help("Comma-separated sections to show")                        .value_name("VALUE")                )        )        .subcommand(
