...
async function runCLI(): Promise<void> {
  try {
    ...
    // Execute the CLI
    console.debug && console.debug(chalk.gray(`Starting Demo TypeScript CLI...`));
    await cliModule.cli();
    console.debug && console.debug(chalk.gray(`Demo TypeScript CLI completed successfully`));
    ...
    console.error(chalk.red.bold('✗ Failed to start Demo TypeScript CLI'));
    ...
    console.error(chalk.cyan('  • Ensure Demo TypeScript CLI is properly installed'));
    ...
    console.error(chalk.cyan('  • Try reinstalling: npm install -g demo-typescript-cli'));
