...
const commandMap = new Map<string, any>();// Level 1: simple
...
simpleCmd.action(async (message: string, options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_simple' as keyof typeof hooks;
...
database_usersCmd.action(async (action: string, options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_database_users' as keyof typeof hooks;
...
database_backupCmd.action(async (options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_database_backup' as keyof typeof hooks;
...
api_v1_users_createCmd.action(async (username: string, email: string, options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_api_users_create' as keyof typeof hooks;
...
api_v1_users_permissions_grantCmd.action(async (user_id: string, permission: string, options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_api_permissions_grant' as keyof typeof hooks;
...
api_v1_users_permissions_revokeCmd.action(async (user_id: string, permission: string, options: any) => {
    const globalOpts = program.opts();
    const verbose: boolean = globalOpts.verbose || false;
    
    try {
        const hookName = 'on_api_permissions_revoke' as keyof typeof hooks;
