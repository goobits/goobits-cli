#!/usr/bin/env node
/**
 * TypeScript Interactive Mode for Nested Command Demo
...
class NestedcommanddemoInteractive {
  ...
  private setupCommands(): void {
    ...
    this.registerCommand({
      ...
      handler: this.handleSimple.bind(this),
  ...
  private loadCommandHistory(): void {
    const historyFile = path.join(process.cwd(), '.demo_history');
    try {
  ...
  start(): void {
    console.log('🚀 Welcome to Nested Command Demo interactive mode');
  ...
  private async handleSimple(args: string[]): Promise<void> {
...
export function runInteractive(): void {
  const interactive = new NestedcommanddemoInteractive();
  interactive.start();
}
