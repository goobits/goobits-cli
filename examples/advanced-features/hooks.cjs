 ...
 * * @param {message} Message to display * @param {Object} options - Command options * @param {flag} options.verbose - Verbose output * @returns {Promise<void>}
 */
async function on_simple(message, options) {
...
/**
 * Database operations
 * * @param {Object} options - Command options * @returns {Promise<void>}
 */
async function on_database() {
    // TODO: Implement your business logic here
...
module.exports = {    on_simple,    on_database,    on_api,};
