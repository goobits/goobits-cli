...
readonly PACKAGE_NAME="nested-demo"
readonly COMMAND_NAME="demo"
readonly DISPLAY_NAME="Nested Command Demo"
readonly DESCRIPTION="Demonstration of deep nested command capabilities"
readonly PYPI_NAME="nested-demo"
