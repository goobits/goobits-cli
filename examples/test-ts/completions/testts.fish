# Fish completion script for Test TypeScript (testts)
...
function __testts_complete_commands
    ...
    echo 'upgrade\tUpgrade Test TypeScript to the latest version'
    echo 'plugin\t🔌 Manage plugins for Test TypeScript'
