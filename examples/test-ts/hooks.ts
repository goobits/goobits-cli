/**
 * Hook system interface for Test TypeScript
 * 
...
export class HookManager {
    ...
    public generateHooksTemplate(): string {
        return `/**
 * Hook implementations for Test TypeScript
 * 
...
/**
 * Say hello
 * * @param name Name to greet * @param options Command options * @returns Promise<void>
 */
export async function on_hello(    name: string): Promise<void> {
    // Add your business logic here
    console.log('Hook on_hello called');    console.log('Arguments:', { name });    
