...
readonly PACKAGE_NAME="spacing-test-cli"
readonly COMMAND_NAME="spacingtest"
readonly DISPLAY_NAME="Spacing Test CLI"
readonly DESCRIPTION="Test CLI for enhanced spacing verification"
readonly PYPI_NAME="spacing-test-cli"
...
readonly SHELL_ALIAS="spacingtest"
