...
readonly PACKAGE_NAME="complex-test-cli"
readonly COMMAND_NAME="complex-test"
readonly DISPLAY_NAME="Complex Test CLI"
readonly DESCRIPTION="Complex test configuration with all features"
readonly PYPI_NAME="complex-test-cli"
...
readonly SHELL_ALIAS="complex-test"
...
show_install_success_message() {
    echo
    echo "Complex test CLI installed successfully!"
    echo
}
...
install_system_dependencies() {
    if command -v apt-get >/dev/null 2>&1; then
        ...
        tree_sub_node "info" "apt-get not found - manual installation required for: git"
    fi
}
