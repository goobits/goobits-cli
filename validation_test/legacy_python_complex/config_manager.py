"""
Configuration management for Complex Test CLI
...
class ConfigManager:
    """Configuration manager for Complex Test CLI"""
    
    def __init__(self):
        self.package_name = 'complex-test-cli'
        self.config_dir_name = 'complex-test-cli'
