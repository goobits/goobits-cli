...
readonly PACKAGE_NAME="minimal-test-cli"
readonly COMMAND_NAME="minimal-test"
readonly DISPLAY_NAME="Minimal Test CLI"
readonly DESCRIPTION="A minimal test CLI for validation"
readonly PYPI_NAME="minimal-test-cli"
readonly DEVELOPMENT_PATH="."
readonly REQUIRED_VERSION="3.8"
readonly MAXIMUM_VERSION="3.13"
readonly CHECK_API_KEYS="False"
readonly CHECK_DISK_SPACE="False"
readonly REQUIRED_MB="100"
readonly SHELL_INTEGRATION="False"
readonly SHELL_ALIAS="minimal-test"
...
show_install_success_message() {
    echo
    echo "Minimal test CLI installed successfully!"
    echo
}
