/**
 * Configuration management for TypeScript Test CLI
...
export class ConfigManager {
    ...
    /**
     * Configuration manager for TypeScript Test CLI
     */
    constructor() {
        this.packageName = 'typescript-test-cli';
        this.configDirName = 'typescript-test-cli';
     ...
     */
    mergeWithEnv(): void {
        const prefix = 'TYPESCRIPT_TEST_CLI_';
