...
A TypeScript test CLI for validation

> A simple TypeScript test CLI
...
```bash
npm install -g typescript-test-cli
```
...
#### `typescript-test hello`
Say hello to someone

```bash
typescript-test hello [OPTIONS]```
...
- **Linux**: `~/.config/typescript-test-cli/`
- **macOS**: `~/Library/Application Support/typescript-test-cli/`
- **Windows**: `%APPDATA%\typescript-test-cli\`
...
**Bash:**
```bash
source completions/typescript-test.bash
```
...
**Fish:**
```bash
cp completions/typescript-test.fish ~/.config/fish/completions/
```
