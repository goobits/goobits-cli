#!/bin/bash
# Enhanced setup script for NodeJS Test CLI
...
COMMAND_NAME="nodejs-test"
DISPLAY_NAME="NodeJS Test CLI"
VERSION="1.0.0"
DESCRIPTION="A NodeJS test CLI for validation"
...
is_development() {
    [ -f "package.json" ] && [ -f "nodejs-test-cli.js" -o -f "cli.js" ]
}
...
show_help() {
    echo ""
    echo -e "${BLUE}NodeJS Test CLI Setup Script${NC}"
    echo "===================================="
    echo ""
