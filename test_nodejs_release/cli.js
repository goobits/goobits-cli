...
🚀 Quick Start:  mkdir my-cli && cd my-cli   # Create new project directory
...
💡 Core Commands:  build    🔨 Generate CLI and setup scripts from goobits.yaml
  serve    🌐 Serve local PyPI-compatible package index
  init     🆕 Create initial goobits.yaml template

🔧 Development Workflow:  1. Edit goobits.yaml: Define your CLI structure  2. goobits build: Generate implementation files  3. Edit app_hooks.py: Add your business logic
