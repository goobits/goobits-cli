"""
Hook system interface for Test CLI
...
class HookManager:
    ...
    def generate_hooks_template(self) -> str:
        ...
        template = f'''"""
Hook implementations for Test CLI
...
def on_hello(name, uppercase=None):
    """
    Say hello
    ...
    print(f"Hook on_hello called")
    print(f"Arguments:name={name}")
    print(f"Options:uppercase={uppercase}")
