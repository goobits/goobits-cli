...
testrust --verbose hello

# Short form of verbose flag
testrust -v hello

# Error handling examples
testrust invalid-command              # Standard error message
testrust --verbose invalid-command   # Detailed error with stack trace
```
...
export TESTRUST_VERBOSE=true
testrust hello

# Disable verbose mode (overrides config)
export TESTRUST_VERBOSE=false
testrust hello
```
...
**Bash:**
```bash
source completions/testrust.bash
```
...
**Fish:**
```bash
cp completions/testrust.fish ~/.config/fish/completions/
```
