...
readonly PACKAGE_NAME="test-app"
readonly COMMAND_NAME="testapp"
readonly DISPLAY_NAME="Test Application"
readonly DESCRIPTION="A simple test CLI"
readonly PYPI_NAME="test-app"
