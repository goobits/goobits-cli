#!/usr/bin/env node
/**
 * Interactive mode for Test TypeScript CLI
...
export class TesttypescriptcliInteractive {
    ...
    public start(): void {
        console.log("Welcome to Test TypeScript CLI interactive mode. Type 'help' for commands, 'exit' to quit.");
    ...
    private async handleBuild(args: string[]): Promise<void> {
        const hookName = 'on_build' as keyof typeof hooks;
        if (typeof hooks[hookName] === 'function') {
            // Parse and validate arguments for the command
    ...
    private async handleServe(args: string[]): Promise<void> {
        const hookName = 'on_serve' as keyof typeof hooks;
        if (typeof hooks[hookName] === 'function') {
            // Parse and validate arguments for the command
