#!/usr/bin/env node
/**
 * Post-install script for test-nodejs-cli
...
// Configuration
const CONFIG = {
    packageName: 'test-nodejs-cli',
    commandName: 'testnode',
    displayName: 'test-nodejs-cli',
    configDirName: 'test-nodejs-cli'
};
...
if (!process.env.CI && !process.env.CONTINUOUS_INTEGRATION) {
    ...
    console.log('📦 Skipping post-install setup in CI/CD environment');
}