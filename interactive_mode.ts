#!/usr/bin/env node
/**
 * Enhanced TypeScript Interactive Mode for TestTSCLI
...
'build'
    ...
    private loadCommandHistory(): void {
        const historyFile = path.join(process.cwd(), '.TestTSCLI_history');
        try {
    ...
    start(): void {
        console.log('🚀 Welcome to TestTSCLI interactive mode');
...
export function runInteractive(): void {
    const interactive = new TesttscliInteractive();
    interactive.start();
}
