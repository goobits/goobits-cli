/**
 * Integration tests for TestRustCLI
...
mod integration_tests {
    ...
    #[test]
    fn test_cli_runs() {
        let mut cmd = Command::cargo_bin("testrust").unwrap();
        cmd.assert().success();
    }
    ...
    fn test_help_command() {
        ...
        cmd.assert()
            .success()
            .stdout(predicate::str::contains("Test Rust CLI for verification"));
    }
    ...
    fn test_config_directory() {
        ...
        assert_eq!(config.settings.version, "1.0.0");
