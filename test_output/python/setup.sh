...
readonly PACKAGE_NAME="test-python-cli"
readonly COMMAND_NAME="testpy"
readonly DISPLAY_NAME="TestPythonCLI"
readonly DESCRIPTION="Test Python CLI for verification"
readonly PYPI_NAME="test-python-cli"
...
readonly REQUIRED_MB="50"
readonly SHELL_INTEGRATION="False"
readonly SHELL_ALIAS="tpy"
...
show_install_success_message() {
    echo
    echo "Test Python CLI installed successfully!"
    echo
}

show_dev_success_message() {
    echo
    echo "Test Python CLI installed in dev mode!"
    echo
}

show_upgrade_success_message() {
    echo
    echo "Test Python CLI upgraded!"
    echo
}

show_uninstall_success_message() {
    echo
    echo "Test Python CLI uninstalled!"
    echo
}
