/**
 * Enhanced Plugin Manager for TestNodeJSCLI
...
export class PluginManager {
  ...
  _getPluginDirectories() {
    ...
    return [
      ...
      join(userConfigDir, 'goobits', 'TestNodeJSCLI', 'plugins'),
  ...
  async _discoverNpmPlugins(discovered) {
    try {
      const pluginPattern = `TestNodeJSCLI-plugin-*`;
  ...
  _isValidPlugin(pkg) {
    return (
      pkg.keywords && 
      (pkg.keywords.includes('TestNodeJSCLI-plugin') || 
