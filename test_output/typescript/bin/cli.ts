 ...
 * CLI executable entry point for TestTypeScriptCLI
...
async function runCLI(): Promise<void> {
  try {
    ...
    // Execute the CLI
    console.debug && console.debug(chalk.gray(`Starting TestTypeScriptCLI...`));
    await cliModule.cli();
    console.debug && console.debug(chalk.gray(`TestTypeScriptCLI completed successfully`));
    ...
    console.error(chalk.red.bold('✗ Failed to start TestTypeScriptCLI'));
    ...
    console.error(chalk.cyan('  • Ensure TestTypeScriptCLI is properly installed'));
