...
readonly PACKAGE_NAME="nargs_test"
readonly COMMAND_NAME="nargscli"
readonly DISPLAY_NAME="Nargs Test CLI"
readonly DESCRIPTION="Test CLI for nargs field debugging"
readonly PYPI_NAME="nargs_test"
