 ...
 * @param {flag} options.force - Force deployment even if there are warnings (use '--force' flag)
 * @param {int} options.timeout - Timeout in seconds (e.g., '--timeout 300')
 * @returns {Promise<void>}
 */
async function on_deploy(environment, options) {
 ...
 *
 * @param {Object} options - Command options
 * @param {str} options.format - Output format: 'json', "yaml", or 'table'
 * @returns {Promise<void>}
 */
async function on_status(options) {
    // TODO: Implement your business logic here
