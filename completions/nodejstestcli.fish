...
function __nodejstestcli_complete_commands
    ...
    echo 'plugin\t🔌 Manage plugins for NodeJSTestCLI'
...
complete -c nodejstestcli -n '__fish_seen_subcommand_from plugin; and __fish_seen_subcommand_from create' -l type -d 'Plugin type' -a 'library binary'
