...
This package contains:
    ...
    - builder.py: Core Builder class for code generation
    - BaseGenerator: Abstract base class for language-specific generators
    - Exception classes: GeneratorError, ConfigurationError, TemplateError, etc.
"""
...
class BaseGenerator(ABC):
    ...
    def _extract_config_metadata(
        self, config: Union[ConfigSchema, GoobitsConfigSchema]
    ) -> dict:
        """
    ...
    def _read_version_from_project_file(
        self, project_dir: Union[str, Path], language: str = "python"
    ) -> Optional[str]:
        """
...
# Shared Exception Classes for All Generators
