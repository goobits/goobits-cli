...
from ...utils.paths import is_e2e_test_path
...
class PythonGenerator(BaseGenerator):
    ...
    def _generate_cli(
        ...
        try:
            ...
            typer.echo(
                f"⚠️  Universal Templates failed ({type(e).__name__}: {e}), "
            ...
            error_msg = (
                "❌ Python CLI Generation Error: Template system initialization failed\n\n"
                "🔧 This indicates a problem with the universal template system.\n"
    ...
    def generate_to_directory(
        ...
        try:
            ...
            is_test_call = (
                flatten_for_tests
                or "tmp" in output_directory
                or "pytest" in output_directory
                or "test_" in str(output_path)
            )
