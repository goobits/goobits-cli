...
class NodeJSGenerator(BaseGenerator):
    ...
    def __init__(self):
        ...
        template_dir = Path(__file__).parent.parent.parent / "templates" / "nodejs"
        ...
        # Add custom filters using shared utilities

        def escape_backticks(text: str) -> str:
            """Escape backtick characters for safe template rendering."""
            return text.replace("`", "\\`")

        # Register custom filters - use shared utilities where available
