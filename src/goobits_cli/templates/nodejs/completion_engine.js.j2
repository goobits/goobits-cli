#!/usr/bin/env node
/**
 * Universal completion engine for goobits-generated CLIs (Node.js)
...
class CompletionEngine {
    ...
    getCompletions(shell, currentLine, cursorPos = null) {
        try {
...
function main() {
    ...
    const cursorPos = process.argv.length > 4 ? parseInt(process.argv[4]) : null;
