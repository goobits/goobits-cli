...
class TestFixtures:
    ...
    def _initialize_common_arguments(self):
        ...
        self.common_arguments = {
            "name": ArgumentSchema(name="name", desc="Name of the item", required=True),
            "file": ArgumentSchema(name="file", desc="File path", required=True),
            "optional_message": ArgumentSchema(
                name="message", desc="Optional message", required=False
            ),
            "multiple_files": ArgumentSchema(
                name="files", desc="Multiple file paths", required=True, multiple=True
            ),
        }
    ...
    def _initialize_common_options(self):
        ...
        self.common_options = {
            "verbose": OptionSchema(
                name="verbose", short="v", type="flag", desc="Enable verbose output"
            ),
            "debug": OptionSchema(name="debug", type="flag", desc="Enable debug mode"),
            "output": OptionSchema(
                name="output",
                short="o",
                type="str",
            ...
            "count": OptionSchema(
                name="count", short="n", type="int", desc="Number of items", default=1
            ),
            "format": OptionSchema(
                name="format",
                short="f",
            ...
            "force": OptionSchema(
                name="force", type="flag", desc="Force overwrite existing files"
            ),
    ...
    def _initialize_common_commands(self):
        ...
        self.common_commands = {
            ...
            "info": CommandSchema(
                desc="Display information", options=[self.common_options["format"]]
            ),
            "deploy": CommandSchema(
                ...
                options=[
                    ...
                    OptionSchema(
                        name="dry_run",
                        type="flag",
                        desc="Preview deployment without executing",
                    ),
                ],
            ),
            ...
            "server": CommandSchema(
                ...
                subcommands={
                    ...
                    "status": CommandSchema(desc="Check server status"),
                },
            ),
        }
    ...
    def _initialize_configs(self):
        ...
        for language in languages:
            ...
            self.minimal_configs[language] = {
                ...
                "messages": {
                    "install_success": f"Minimal{language.title()}CLI installed successfully!"
                },
                "cli": {
            ...
            self.basic_configs[language] = {
                ...
                "messages": {
                    "install_success": f"Basic{language.title()}CLI installed successfully!"
                },
                "cli": {
            ...
            self.complex_configs[language] = {
                ...
                "messages": {
                    "install_success": f"Complex{language.title()}CLI installed successfully!"
                },
                "cli": {
    ...
    def _initialize_error_scenarios(self):
        ...
        self.error_scenarios = {
            "missing_required_arg": {
                ...
                "expected_patterns": self.expected_outputs["error_patterns"][
                    "missing_arg"
                ],
            },
            "invalid_command": {
...
def create_test_config(
    ...
    return GoobitsConfigSchema(
        ...
        shell_integration=ShellIntegrationSchema(
            **config_data.get("shell_integration", {})
        ),
