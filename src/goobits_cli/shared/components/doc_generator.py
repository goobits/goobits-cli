...
class DocumentationGenerator:
    ...
    def __init__(self, language: str, config: Dict[str, Any], template_dir: Optional[str] = None):
    ...
    def _get_template_context(self) -> Dict[str, Any]:
        ...
        # Add error templates
        context['error_templates'] = self.customizations.get('error_templates', {}).get(self.language, {})
        
        # Add completion support info
        context['completion_support'] = self.customizations.get('completion_support', {}).get(self.language, {})
        
        # Add help formatting preferences
        context['help_formatting'] = self.customizations.get('help_formatting', {}).get(self.language, {})
    ...
    def generate_help_text(self, command_name: str, command_data: Dict[str, Any]) -> str:
        ...
        context.update({
            ...
            'current_command_data': command_data
        })
...
"""
    ...
    def generate_error_message(self, error_type: str, **kwargs) -> str:
        ...
        """
        error_templates = self.customizations.get('error_templates', {}).get(self.language, {})
    ...
    def get_documentation_sections(self) -> Dict[str, List[str]]:
        ...
        """
        return self.customizations.get('documentation_sections', {}).get(self.language, {
            'include': [],
            'exclude': []
        })
    
    def generate_custom_section(self, section_name: str, template_string: str, **kwargs) -> str:
...
def create_documentation_generator(language: str, config: Dict[str, Any]) -> DocumentationGenerator:
...
def generate_installation_guide_for_language(language: str, config: Dict[str, Any]) -> str:
