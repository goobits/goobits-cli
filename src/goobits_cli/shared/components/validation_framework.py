...
class BaseValidator(ABC):
    ...
    def validate_identifier(self, name: str, field_path: str, result: ValidationResult,
                          allow_hyphens: bool = True, language: str = "python") -> bool:
        ...
        if language == "rust":
            ...
            valid_pattern = r'^[a-zA-Z_$][a-zA-Z0-9_$]*$' if not allow_hyphens else r'^[a-zA-Z_$][a-zA-Z0-9_$-]*$'
    ...
    def _get_reserved_words(self, language: str) -> Set[str]:
        ...
        reserved = {
            ...
            "typescript": {
                ...
                "synchronized", "this", "throw", "throws", "transient",
                "true", "try", "typeof", "var", "void", "volatile", "while",
                "with", "yield", "any", "never", "unknown", "string",
                "number", "bigint", "symbol", "object"
            },
            "rust": {
    ...
    def _compute_execution_order(self) -> None:
        ...
        def visit(validator_name: str):
            if validator_name in temp_visited:
                raise ValueError(f"Circular dependency detected involving {validator_name}")
...
class ValidationRunner:
    ...
    def validate_specific(self, validator_names: List[str], context: ValidationContext) -> ValidationResult:
...
def validate_config(config: Any, language: str = "python", 
                   mode: ValidationMode = ValidationMode.STRICT,
