...
class TestValidationFramework:
    ...
    def test_validation_context(self):
        ...
        context = ValidationContext(
            config=config, language="python", mode=ValidationMode.STRICT
        )
...
class TestCommandValidator:
        ...
        return {
            "cli": {
                ...
                "commands": {
                    ...
                    "test": {"desc": "Run tests", "args": [], "options": []},
                },
            }
        }
    ...
    def test_missing_command_description(self):
        ...
        config = {"cli": {"commands": {"build": {}}}}  # Missing description
    ...
    def test_command_groups_validation(self):
        ...
        config = {
            "cli": {
                ...
                "command_groups": [
                    {"name": "Development", "commands": ["build", "test"]},
                    {
...
class TestArgumentValidator:
    ...
    def test_argument_order_validation(self):
        ...
        errors = result.get_errors()
        assert any(
            "Required argument" in error.message and "after optional" in error.message
            for error in errors
        )
...
class TestConfigValidator:
    ...
    def test_python_version_validation(self):
        ...
        errors = result.get_errors()
        assert any(
            "minimum" in error.message.lower() and "maximum" in error.message.lower()
            for error in errors
        )
...
class TestErrorCodeValidator:
    ...
    def test_error_code_standards(self):
        ...
        context = ValidationContext(
            config={}, language="python", mode=ValidationMode.DEV
        )
        validator.validate(context)
...
class TestCompletionValidator:
    ...
    def test_completion_analysis(self):
        ...
        info_messages = [
            msg for msg in result.messages if msg.severity == ValidationSeverity.INFO
        ]
    ...
    def test_completion_optimization_suggestions(self):
        ...
        validator = CompletionValidator()
        context = ValidationContext(
            config=config, language="python", mode=ValidationMode.DEV
        )
        result = validator.validate(context)
        ...
        assert any(
            "benefit from predefined choices" in msg.message for msg in info_messages
        )
...
class TestIntegrationScenarios:
    ...
    def test_validation_performance(self):
        ...
        large_config = {
            ...
            "cli": {"name": "Large CLI", "commands": commands},
        }
