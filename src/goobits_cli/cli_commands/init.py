"""Init command implementation for goobits CLI.

This module contains the init command that creates initial goobits.yaml
template files from various predefined templates (basic, advanced,
api-client, text-processor).
"""
...
def generate_basic_template(project_name: str) -> str:
    """Generate a basic CLI template configuration."""
...
def generate_advanced_template(project_name: str) -> str:
    """Generate an advanced CLI template configuration."""
...
def generate_api_client_template(project_name: str) -> str:
    """Generate an API client CLI template configuration."""
...
def generate_text_processor_template(project_name: str) -> str:
    """Generate a text processor CLI template configuration."""
