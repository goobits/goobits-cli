...
║  src/goobits_cli/templates/prompts_helper.py.j2                             ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝

Interactive prompts and input helpers for Goobits CLI Framework
"""
...
def multiselect(
    message: str, choices: List[Union[str, Dict]], default: Optional[List[str]] = None
) -> List[str]:
