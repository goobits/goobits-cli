...
class PythonBuiltinAdapter(BaseBuiltinAdapter):
    ...
    print("🔍 Running {config.project_name} diagnostics...")
    ...
    try:
        ...
        if config_dir.exists():
            ...
            print("ℹ️  Configuration directory will be created when needed")
    ...
    if issues:
        ...
        print("\\n✅ All checks passed! {config.project_name} is healthy.")'''
...
class NodeJSBuiltinAdapter(BaseBuiltinAdapter):
    ...
    console.log("🔍 Running {config.project_name} diagnostics...");
    ...
    try {{
        require('commander');
        console.log("✅ Commander dependency available");
    }} catch (error) {{
    ...
    try {{
        ...
        if (fs.existsSync(configDir)) {{
            ...
            console.log("✅ Configuration directory writable");
        }} else {{
            console.log("ℹ️  Configuration directory will be created when needed");
        }}
    }} catch (error) {{
...
interface PackageInfo {
    ...
    console.log("🔍 Running {config.project_name} diagnostics...");
    console.log("✅ All checks passed! {config.project_name} is healthy.");
}}'''
...
pub struct ConfigOptions {
    ...
    println!("🔍 Running {config.project_name} diagnostics...");
    println!("✅ All checks passed! {config.project_name} is healthy.");
}}'''