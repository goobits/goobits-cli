...
# Import feature detection capabilities
...
class UniversalTemplateEngine:
    ...
    def analyze_feature_requirements(
        ...
        # Feature detection heuristics using FeatureDetector
        requirements = {
            "rich_interface": FeatureDetector.needs_rich_formatting(cli_config, config_dict),
            "interactive_mode": FeatureDetector.has_interactive_commands(cli_config),
            "completion_system": FeatureDetector.has_completion_subcommands(cli_config),
            "complex_parsing": FeatureDetector.has_complex_arguments(cli_config),
            "config_management": FeatureDetector.has_config_features(cli_config),
            "async_features": FeatureDetector.has_async_features(cli_config),
            "plugin_system": FeatureDetector.has_plugin_features(cli_config),
            # Enhanced granular feature detection
            "table_formatting": FeatureDetector.needs_table_formatting(cli_config),
            "progress_features": FeatureDetector.needs_progress_features(cli_config),
            "color_support": FeatureDetector.needs_color_support(cli_config),
            "complex_types": FeatureDetector.has_complex_types(cli_config),
            "file_operations": FeatureDetector.needs_file_operations(cli_config),
            # Node.js/TypeScript specific optimizations
            "subcommand_nesting": FeatureDetector.has_nested_subcommands(cli_config),
            "commander_help_formatting": FeatureDetector.needs_commander_help_formatting(
                cli_config
            ),
        }
