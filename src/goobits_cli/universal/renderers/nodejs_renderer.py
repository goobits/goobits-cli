...
class NodeJSRenderer(LanguageRenderer):
    ...
    def file_extensions(self) -> Dict[str, str]:
        ...
        return {"js": "javascript", "json": "json", "md": "markdown", "logger": "js"}
        ...
        context.update(
            {
                ...
                "commander_commands": self._build_commander_structure(
                    ir.get("cli", {})
                ),
                ...
                "nodejs": {
                    ...
                    "package_config": {
                        ...
                        "description": ir.get("project", {}).get(
    ...
    def _build_subcommand_hooks(
        self, subcommands: List[Dict[str, Any]], parent_name: str
    ) -> List[Dict[str, str]]:
    ...
    def _post_process_javascript(self, content: str) -> str:
        ...
        content = re.sub(
            ...
            lambda m: f"import {{ {m.group(1).strip()} }} from ",
            content,
        )
