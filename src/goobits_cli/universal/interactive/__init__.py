...
def integrate_interactive_mode(cli_config: dict, language: str) -> dict:
    ...
    interactive_config = {
        ...
        "tab_completion": existing_interactive.get(
            "tab_completion", is_tab_completion_supported(language)
        ),
        "repl": existing_interactive.get(
            "repl", False
        ),  # Respect user setting, default False for compatibility
...
def get_interactive_launch_code(
    language: str, option_name: str = "interactive"
) -> dict:
    """
