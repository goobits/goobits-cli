...
from ..interactive.nodejs_utils_simple import NodeJSInteractiveUtils, get_nodejs_interactive_dependencies
...
class TestNodeJSInteractiveTestsGeneration(unittest.TestCase):
    ...
    def test_test_code_generation(self):
        ...
        from ..interactive.nodejs_utils_simple import get_nodejs_interactive_tests
