...
from ..completion.registry import (
    DynamicCompletionRegistry, 
    CompletionProvider, 
    CompletionContext,
    get_completion_registry
)
from ..completion.providers import (
...
from ..completion.integration import (
    InteractiveCompletionIntegrator,
    setup_completion_for_language
)


class TestCompletionProvider(CompletionProvider):
    """Test completion provider for testing."""
...
class TestDynamicCompletionRegistry:
    ...
    def test_provider_registration(self):
        ...
        provider = TestCompletionProvider(priority=100)
    ...
    def test_provider_priority_ordering(self):
        ...
        provider1 = TestCompletionProvider(priority=30)
        provider2 = TestCompletionProvider(priority=100)
        provider3 = TestCompletionProvider(priority=50)
    ...
    async def test_get_completions(self):
        ...
        provider = TestCompletionProvider(test_completions=['test1', 'test2', 'testing'])
        self.registry.register_provider(provider)
