...
class PythonGenerator(BaseGenerator):
    ...
    def _generate_with_universal_templates(
        self, 
        config: Union[ConfigSchema, GoobitsConfigSchema], 
        config_filename: str, 
        version: Optional[str] = None
        ...
        try:
            ...
            error_msg = (
                "❌ Python CLI Generation Error: Universal Templates are required\n\n"
            ...
            typer.echo(error_msg, err=True)
            raise RuntimeError("Python generator reached unexpected fallback path") from e
