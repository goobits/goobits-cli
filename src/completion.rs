...
impl CompletionEngine {
    pub fn new() -> Self {
        Self {
            cli_name: "Quadruple Check CLI".to_string(),
            commands: vec![                CompletionCommand {
                    name: "greet".to_string(),
                    description: "Greet someone with multi-language support".to_string(),
                    options: vec![                        CompletionOption {
                            ...
                            short: None,
                            description: "Greeting language".to_string(),
                        },                        CompletionOption {
                    ...
                    arguments: vec![                        CompletionArgument {
                            ...
                            description: "Custom message".to_string(),
                        },                    ],
                },                CompletionCommand {
                    name: "info".to_string(),
                    ...
                    options: vec![                        CompletionOption {
                            ...
                            short: None,
                            description: "Show verbose information".to_string(),
                        },                        CompletionOption {
