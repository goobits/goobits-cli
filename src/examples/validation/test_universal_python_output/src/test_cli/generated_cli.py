...
def _path_to_import_path(file_path: str, package_name: str = "test_universal_cli") -> tuple[str, str]:
...
# No hooks path configured, try default locations
    ...
    try:
        return importlib.import_module(f".{default_module_name}", package="test_universal_cli")
    except ImportError:
        pass
