...
# ║                        AUTO-GENERATED FILE                               ║
# ║                                                                           ║
# ║  Generated by: goobits-cli vunknown                     ║
# ║  Generated from:                                          ║
# ║                                                                           ║
...
readonly PACKAGE_NAME="test-universal-cli"
readonly COMMAND_NAME="test-cli"
readonly DISPLAY_NAME="Test Universal CLI"
readonly DESCRIPTION="A test CLI for validating Universal Template System functionality"
readonly PYPI_NAME="test-universal-cli"
