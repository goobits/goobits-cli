...
This is a standalone validation script that directly tests the Universal Template System,
not part of the pytest test suite. It's useful for manual validation and debugging
of universal template rendering across different languages.
"""
    ...
    for language_name, renderer in languages:
        ...
        try:
            ...
            generated_files = engine.generate_cli(
                test_config, language_name, output_dir
            )
