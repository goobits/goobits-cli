...
fn main() {
    ...
    let app = Command::new("")
        ...
        .subcommand(
            Command::new("upgrade")
                .about("Upgrade Quadruple Check CLI to the latest version")
                .arg(
                    Arg::new("check")
                        .long("check")
        ...
        .subcommand(
            Command::new("greet")
                .about("Greet someone with multi-language support")
                .arg(
                    Arg::new("name")
                ...
                .arg(
                    Arg::new("style")
                        .long("style")                        .help("Greeting style")                        .action(clap::ArgAction::Set)
                )
                .arg(
                    Arg::new("language")
                        .long("language")                        .help("Greeting language")                        .action(clap::ArgAction::Set)
                )
                .arg(
                    Arg::new("count")
                        .long("count")                        .help("Number of times to repeat")                        .action(clap::ArgAction::Set)
                )
                .arg(
                    Arg::new("uppercase")
                        .long("uppercase")                        .help("Convert to uppercase")                        .action(clap::ArgAction::SetTrue)                )
        )
        .subcommand(
            Command::new("info")
                ...
                .arg(
                    Arg::new("verbose")
                        .long("verbose")                        .help("Show verbose information")                        .action(clap::ArgAction::SetTrue)                )
                .arg(
                    Arg::new("sections")
                        .long("sections")                        .help("Comma-separated sections to show")                        .action(clap::ArgAction::Set)
                )
        )
;
    ...
    match matches.subcommand() {
        Some(("upgrade", sub_matches)) => {
            ...
            let package_name = "quadruple-test-cli";
            let command_name = "quad-cli";
            let display_name = "Quadruple Check CLI";
