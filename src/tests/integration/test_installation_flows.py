...
class TestInstallationWorkflows:
    ...
    def _test_cli_functionality(self, command_name: str, expected_commands: List[str] = None):
        ...
        if PackageManagerHelper.check_availability("yarn"):
            try:
                result = PackageManagerHelper.run_command(["yarn", "global", "bin"], timeout=30)
        ...
        for cmd_arg in expected_commands:
            try:
                result = PackageManagerHelper.run_command([command_name, cmd_arg], timeout=30, env=enhanced_env)
