...
class TestLoggingIntegration:
    ...
    def test_performance_context_operations(self):
        ...
        assert avg_time_per_operation < 0.01, f"Context operations too slow: {avg_time_per_operation*1000:.2f}ms per operation"
        ...
        assert avg_time_per_get < 0.01, f"Context get operations too slow: {avg_time_per_get*1000:.2f}ms per operation"
