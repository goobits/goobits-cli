...
"""
    ...
    def test_load_all_components(self):
        ...
        expected_components = {
            "command_handler", "config_manager", "main_cli", 
            "hook_system", "invalid_template", "complex_template"
        }
...
def greet():
    ...
    print("こんにちは 🇯🇵")
"""
        (self.components_dir / "utf8_template.j2").write_text(utf8_content, encoding='utf-8')
...
"""
            (self.components_dir / f"generated_component_{i}.j2").write_text(component_content)
