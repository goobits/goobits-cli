...
class TestInteractiveMode:
    ...
    def test_nodejs_interactive_rendering(self, sample_ir, template_engine):
        ...
        assert (
            "interactive_mode" in output_structure
        ), f"Interactive mode not found in: {list(output_structure.keys())}"
    ...
    def test_command_handler_integration(self, sample_ir, template_engine):
        ...
        command_template = template_engine.component_registry.get_component(
            "command_handler"
        )
        ...
        rendered = renderer.render_component(
            "command_handler", command_template, context
        )
    ...
    def test_interactive_prompt_customization(self, sample_ir, template_engine):
        ...
        assert (
            'prompt = "test-cli> "' in rendered
            or 'self.prompt = "test-cli> "' in rendered
        )
