"""
Hook system interface for Test Interactive CLI
...
class HookManager:
    ...
    def generate_hooks_template(self) -> str:
        ...
        template = f'''"""
Hook implementations for Test Interactive CLI
...
import sys
import os
def on_hello(name, loud=None):
    """
    Say hello to the world

    Args:        name (str): Name to greet        loud (str): Use uppercase    """
    # TODO: Implement your business logic here
    print(f"Hook on_hello called")    print(f"Arguments:name={name}")    print(f"Options:loud={loud}")
...
def on_goodbye(name):
    ...
    Args:        name (str): Name to bid farewell    """
    # TODO: Implement your business logic here
    print(f"Hook on_goodbye called")    print(f"Arguments:name={name}")
    # Return 0 for success, non-zero for error
    return 0
