...
def _path_to_import_path(file_path: str, package_name: str = "goobits_cli") -> tuple[str, str]:
    ...
    try:
        if "." in import_path:
            ...
            if len(package_parts) >= 2:
                ...
                return importlib.import_module(f".{relative_import}", package="goobits_cli")
        else:
            # Direct relative import
            return importlib.import_module(f".{module_name}", package="goobits_cli")
    except ImportError:
        pass
