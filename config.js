/**
 * Configuration management for Test String Escape CLI
 */
...
class ConfigManager {
    ...
    _getDefaultConfigPath() {
        const configDir = path.join(os.homedir(), '.config', 'test-string-escape-cli');
    ...
    loadConfig() {
        ...
        const envPrefix = 'TEST_STRING_ESCAPE_CLI_';
