/**
 * Enhanced Plugin Manager for Test Node.js CLI
...
export class PluginManager {
  ...
  _getPluginDirectories() {
    ...
    return [
      ...
      join(userConfigDir, 'goobits', 'testnode', 'plugins'),
  ...
  async _discoverNpmPlugins(discovered) {
    try {
      const pluginPattern = `testnode-plugin-*`;
  ...
  _isValidPlugin(pkg) {
    return (
      pkg.keywords && 
      (pkg.keywords.includes('testnode-plugin') || 
