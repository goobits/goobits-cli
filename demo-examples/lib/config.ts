...
export class ConfigManager {
    ...
    /**
     * Configuration manager for Demo TypeScript CLI
     */
    constructor() {
        this.packageName = 'demo-typescript-cli';
        this.configDirName = 'demo-typescript-cli';
     ...
     */
    mergeWithEnv(): void {
        const prefix = 'DEMO_TYPESCRIPT_CLI_';
