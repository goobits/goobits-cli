#!/bin/bash
# Enhanced setup script for Complex CLI Test Tool
...
is_development() {
    [ -f "package.json" ] && [ -f "complex-cli.js" -o -f "cli.js" ]
}
...
show_help() {
    echo ""
    echo -e "${BLUE}Complex CLI Test Tool Setup Script${NC}"
    echo "===================================="
    echo ""
