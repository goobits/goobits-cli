/**
 * Enhanced Plugin Manager for Complex CLI Test Tool
...
export class PluginManager {
  ...
  _getPluginDirectories() {
    ...
    return [
      ...
      join(userConfigDir, 'goobits', 'complex-cli', 'plugins'),
  ...
  async _discoverNpmPlugins(discovered) {
    try {
      const pluginPattern = `complex-cli-plugin-*`;
  ...
  _isValidPlugin(pkg) {
    return (
      pkg.keywords && 
      (pkg.keywords.includes('complex-cli-plugin') || 
