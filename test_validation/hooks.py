"""
Hook system interface for Test Python CLI
...
import sys
import os
def on_greet(__loud=None):
    """
    Greet someone

    Args:        __loud (str): Greet loudly    """
    # TODO: Implement your business logic here
    print(f"Hook on_greet called")    print(f"Options:__loud={__loud}")
