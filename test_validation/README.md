...
Test CLI for TypeScript validation

> Test CLI for validation
...
```bash
testcli greet [OPTIONS]```


**Options:**
- `----loud <str>`: Greet loudly
...
- **Linux**: `~/.config/test-typescript-cli/`
- **macOS**: `~/Library/Application Support/test-typescript-cli/`
- **Windows**: `%APPDATA%\test-typescript-cli\`
